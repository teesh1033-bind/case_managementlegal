            ...
            <a href="' . htmlspecialchars($page['file']) . '" class="card legalpro-doc-hub-card h-100 text-decoration-none">
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-start gap-2 mb-3">
                        ...
                        <span class="badge bg-light text-dark">' . (int) $meta['count'] . ' ' . htmlspecialchars($meta['countLabel']) . '</span>
                    </div>
...
<head>
    ...
    $html .= ob_get_clean();
    $html .= '<link href="../assets/css/legalpro-finance-pages.css?v=4" rel="stylesheet" />'
