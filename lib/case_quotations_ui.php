    ...
    if (empty($quotations)) {
        ...
        foreach ($quotations as $quotation) {
            ...
            $items .= '<article class="case-feed-item case-quotation-card flex-wrap align-items-start">'
                ...
                . '<a href="client-quotation-view.php?id=' . $quoteId . '&view=1" class="btn btn-sm lp-portal-accent-btn mb-0" target="_blank" rel="noopener">View</a>'
                . '<button type="button" class="btn btn-sm lp-portal-accent-btn mb-0 case-quotation-edit-btn" data-quotation-id="' . $quoteId . '">Edit</button>'
