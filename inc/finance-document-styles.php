...
function legalpro_finance_document_css(): string
{
    ...
    return ''
        ...
        . '.fin-doc--invoice{border-radius:0;border:none;box-shadow:none;max-width:820px;}'
        . 'body.fin-doc-page .fin-doc--invoice{margin:0 auto;}'
        . '.fin-doc-inv-header{background:#fff;border-bottom:none;padding:0;}'
        . '.fin-doc-inv-header-inner{display:table;width:100%;padding:26px 40px 16px;}'
        . '.fin-doc-inv-col{display:table-cell;vertical-align:top;}'
        . '.fin-doc-inv-col--brand{width:58%;padding-right:16px;}'
        . '.fin-doc-inv-col--meta{width:42%;text-align:right;padding-left:12px;}'
        . '.fin-doc-inv-brand{display:table;}'
        . '.fin-doc-inv-logo{display:table-cell;vertical-align:middle;width:54px;height:54px;max-width:120px;max-height:54px;object-fit:contain;border-radius:8px;padding:2px;margin-right:12px;background:#fff;}'
        . '.fin-doc-inv-brand-text{display:table-cell;vertical-align:middle;}'
        . '.fin-doc-inv-firm{font-size:15px;font-weight:800;color:#111827;letter-spacing:.04em;line-height:1.25;}'
        . '.fin-doc-inv-doc-label{font-family:Georgia,"Times New Roman",Times,serif;font-size:36px;font-weight:700;color:' . $c['primary'] . ';letter-spacing:.02em;line-height:1;margin:0 0 6px;text-transform:uppercase;}'
        . '.fin-doc-inv-number{font-size:13px;font-weight:800;color:#111827;letter-spacing:.01em;}'
        . '.fin-doc--invoice .fin-doc-body{padding:18px 40px 36px;}'
        . '.fin-doc-inv-parties{display:table;width:100%;margin:16px 0 30px;}'
        . '.fin-doc-inv-party{display:table-cell;vertical-align:top;width:50%;}'
        . '.fin-doc-inv-party--from{padding-right:28px;}'
        . '.fin-doc-inv-party--to{text-align:right;padding-left:18px;}'
        . '.fin-doc-inv-party-name{font-size:15px;font-weight:800;color:#111827;margin:0 0 6px;}'
        . '.fin-doc-inv-party-line{font-size:12px;color:#64748b;line-height:1.55;margin-bottom:2px;}'
        . '.fin-doc-inv-party--to .fin-doc-section-title{color:#111827;margin-bottom:6px;letter-spacing:.04em;}'
        . '.fin-doc-inv-dates{margin-top:14px;font-size:12px;color:#334155;line-height:1.7;}'
        . '.fin-doc-inv-dates strong{color:#111827;font-weight:700;}'
        . '.fin-doc-table--invoice{border:none;border-radius:0;overflow:hidden;}'
        . '.fin-doc-table--invoice th{background:#111827;color:#fff;border-bottom:none;padding:13px 14px;font-size:10px;}'
        . '.fin-doc-table--invoice td{border-bottom:1px solid #e5e7eb;padding:18px 14px;vertical-align:middle;}'
        . '.fin-doc-table--invoice tbody tr:last-child td{border-bottom:1px solid #d1d5db;}'
        . '.fin-doc-table--invoice tbody tr:nth-child(even){background:#fff;}'
        . '.text-center{text-align:center;}'
        . '.fin-doc-amount-cell{font-weight:800;color:#111827;font-size:13px;}'
        . '.fin-doc-section--items{margin-bottom:24px;}'
        . '.fin-doc-section--notes{margin-bottom:24px;}'
        . '.fin-doc-inv-bottom{display:table;width:100%;margin-top:16px;}'
        . '.fin-doc-inv-bottom-pay{display:table-cell;vertical-align:top;width:50%;padding-right:24px;}'
        . '.fin-doc-inv-bottom-totals{display:table-cell;vertical-align:top;width:50%;}'
        . '.fin-doc-inv-bottom-pay .fin-doc-payment{margin-top:14px;padding-top:0;border-top:none;}'
        . '.fin-doc-inv-payable{margin-bottom:10px;}'
        . '.fin-doc-inv-payable-label{display:block;font-size:12px;color:#64748b;margin-bottom:4px;}'
        . '.fin-doc-inv-payable-name{display:block;font-size:16px;font-weight:800;color:' . $c['primary'] . ';letter-spacing:.02em;text-transform:uppercase;}'
        . '.fin-doc-inv-payable-vat{margin-top:4px;font-size:11px;color:#64748b;}'
        ...
        . '.fin-doc-summary-box{background:' . $c['primary'] . ';color:#fff;border-radius:10px;padding:22px 22px;margin-top:0;}'
        ...
        . '.fin-doc-inv-footer{margin-top:34px;padding-top:18px;border-top:1px solid #e5e7eb;text-align:center;}'
        . '.fin-doc-inv-footer-thanks{margin-top:0;font-size:12px;color:#94a3b8;font-weight:500;}'
        . '.fin-doc-action--download{background:' . $c['primary'] . ';color:#fff;border-color:' . $c['primary'] . ';}'
