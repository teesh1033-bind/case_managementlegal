...
function legalpro_finance_document_css(): string
{
    ...
    return ''
        ...
        . '.fin-doc-top > div:first-child{display:table-cell;vertical-align:top;width:70%;}'
        . '.fin-doc-top-actions{display:table-cell;vertical-align:top;text-align:right;white-space:nowrap;}'
        . '.fin-doc-top h1{margin:0 0 4px;font-size:22px;font-weight:700;letter-spacing:-.02em;}'
        . '.fin-doc-top .fin-doc-firm{font-size:13px;opacity:.9;}'
