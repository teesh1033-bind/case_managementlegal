...
<aside class="navbar navbar-vertical navbar-expand-xs legalpro-admin-sidebar" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse show w-100 legalpro-sidebar-nav-wrap" id="sidenav-collapse-main">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (sidebar) {
        sidebar.classList.remove('ps', 'ps--active-y');
