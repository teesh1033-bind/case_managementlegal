...
=======
        $caseTitle = $invoice['case_title'] ?: 'ΓÇö';
>>>>>>> ac2cdddeafa742e6db4c37a5d32f4040c35f85fd
...
=======
        $refDisp = strlen($ref) > 24 ? htmlspecialchars(substr($ref, 0, 24)) . 'ΓÇª' : htmlspecialchars($ref);
        $caseTitle = $payment['case_title'] ?: 'ΓÇö';
>>>>>>> ac2cdddeafa742e6db4c37a5d32f4040c35f85fd
...
=======
                            <input type="search" name="q" class="form-control" placeholder="Search invoices & paymentsΓÇª" value="" autocomplete="off" maxlength="200" aria-label="Search">
>>>>>>> ac2cdddeafa742e6db4c37a5d32f4040c35f85fd
                        </div>
                    </form>
