...
<head>
	...
	<title>LexMate Case Manager - Appointments</title>
	...
	<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
		<div class="sidenav-header">
			...
			<a class="navbar-brand m-0" href="../pages/dashboard.php">
				<img src="../assets/img/logo-ct-dark.png" width="26" height="26" class="navbar-brand-img h-100" alt="LexMate logo">
				<span class="ms-1 font-weight-bold">LexMate Case Manager</span>
			</a>
		</div>
