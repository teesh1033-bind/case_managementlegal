...
$notifications = legalpro_fetch_lawyer_notifications($pdo, $lawyerId, 100);
$listHtml = '';
...
<head>
    ...
    <style>
        ...
        .lawyer-notifications-page .legalpro-notif-item {
            border-radius: 12px;
            border: 1px solid #e9ecef;
            background: #fff;
        }
        body.legalpro-dark-mode.lawyer-notifications-page .legalpro-notif-item {
